...
data class Event(
        ...
        @SerializedName("intSpectators") var intSpectators: String?,
        ...
        @SerializedName("strResult") var strResult: String?,
        @SerializedName("strCircuit") var strCircuit: String?,
        @SerializedName("strCountry") var strCountry: String?,
        @SerializedName("strCity") var strCity: String?,
        @SerializedName("strPoster") var strPoster: String?,
        @SerializedName("strFanart") var strFanart: String?,
        @SerializedName("strThumb") var strThumb: String?,
        @SerializedName("strBanner") var strBanner: String?,
        @SerializedName("strMap") var strMap: String?,
